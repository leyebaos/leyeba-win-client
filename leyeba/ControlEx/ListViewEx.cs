...
namespace ControlEx
{
	...
	public class ListViewEx : ListView
	{
		...
		public ListViewEx() 
        {
            //this.ColumnWidthChanging += ListViewEx_ColumnWidthChanging;
        }

        void ListViewEx_ColumnWidthChanging(object sender, ColumnWidthChangingEventArgs e)
        {
            // 如果调整的不是第一列,就不管了 
